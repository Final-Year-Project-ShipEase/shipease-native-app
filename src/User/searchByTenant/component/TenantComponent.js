    ...
    <View style={styles.component1}>
      ...
      <View style={styles.card1}>
        <Image
          ...
          contentFit="cover"
          source={require("../component/tenant1.png")}
        />
        <View style={[styles.bestVehicleText, styles.bestLayout]}>
          ...
          <View style={styles.jumboTrailerParent}>
            <Text style={styles.jumboTrailer}>Rock aadi</Text>
            <View style={styles.faisalabadParent}>
              <Text style={styles.faisalabad}>{'Rocket.aadi@gmail.com'}</Text>
            </View>
          </View>
        </View>
      </View>
    ...
    <View style={styles.component2}>
      ...
      <View style={styles.card1}>
        <Image
          style={styles.stockPhotoEindhovenTheNethIcon}
          contentFit="cover"
          source={require("../component/tenant2.png")}
        />
        <View style={[styles.bestVehicleText, styles.bestLayout]}>
          <View style={[styles.bestVehicleTextChild, styles.bestLayout]} />
          <View style={styles.jumboTrailerParent}>
            <Text style={styles.jumboTrailer}>David Will</Text>
            <View style={styles.faisalabadParent}>
              <Text style={styles.faisalabad}>{`david.will@gmail.com`}</Text>
            </View>
          </View>
        </View>
      </View>
