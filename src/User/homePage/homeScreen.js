            ...
            <View style={styles.container}>
                ...
                <View style={styles.avatar}>
                    ...
                    <View style={styles.iconsContainer}>
                        <Ionicons name="search" size={24} color={theme.palette.homePage.searchIconColor} style={styles.icon} />
                        <Ionicons name="notifications" size={24} color={theme.palette.homePage.notificationIconColor} style={styles.icon} />
                        <Ionicons name="settings" size={24} color={theme.palette.homePage.settingIconColor} style={styles.icon} />
                    </View>
                </View>
